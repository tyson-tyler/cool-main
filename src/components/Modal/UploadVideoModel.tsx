...
const UploadVideoModel: React.FC<UploadVideoModalProps> = ({ onUpload }) => {
  ...
  return (
    <div className="absolute mt-10 left-1/2 lg:w-5/6  lg:h-5/6 w-full h-[75vh] rounded-xl  transform -translate-x-1/2 -translatex-y-1/2 flex flex-col justify-start bg-gray-100 shadow-md text-black dark:bg-gray-700 dark:text-white mb-10 z-50">
