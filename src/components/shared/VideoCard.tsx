...
const VideoCard: React.FC<VideoCardProps> = ({
  ...
  return (
    <Link
      ...
      prefetch={true}
    >
      <div className="relative w-full flex justify-center md:h-[500px] max-w-[100px] sm:max-w-[200px] md:max-w-[300px] lg:max-w-[500px]  lg:h-[550px] sm:h-[500px] h-[400px] aspect-video">
