...
const Videomodel = () => {
  return (
    <div className="flex flex-row-reverse justify-center w-full flex-wrap mt-5 m-auto">
      <div>
        {" "}
        <h1 className="head_text text-center lg:pt-[200px] md:pt-[100px] sm:pt-[50px] pt-[30px] dark:text-white text-black">
          <span className="dark:text-white text-black ml-3">
            Vist to Community.
          </span>
          <br className="max-md:hidden" />
        </h1>
        <p className="desc text-center text-gray-600 mt-5">
          In Our Community you can find Best Ai Image
        </p>
