...
import VideoCard from "./shared/VideoCard"; // Adjust import as per your project structure
import { SkeletonCard } from "./Sketon"; // Adjust import as per your project structure
...
export default function SearchPageContent() {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      if (!searchQuery) {
        setLoading(false);
        return; // If no search query, do nothing
      }
          ...
          <div className="w-full h-fit justify-center flex items-center flex-col">
            <div className="flex justify-center items-center flex-col">
              ...
              <span className="text-xl font-semibold">
                {searchQuery ? "No videos found" : "No query"}
              </span>
            </div>
          </div>
        )}
