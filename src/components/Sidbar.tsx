          ...
          (item, index) =>
            ...
            (!item.requiresChannel || currentUser) && (
              <div
                ...
                className={`flex items-center cursor-pointer transition-transform transform hover:scale-105 hover:bg-gray-100 dark:hover:bg-gray-700 sm:p-[10px] md:p-[10px] lg:p-[8px] rounded-md ${
                  pathname === item.path
